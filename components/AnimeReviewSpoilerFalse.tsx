...
import {
  getNextSubscribeSpoilerFalseReviews,
  subscribeSpoilerFalseReviews,
...
const AnimeReviewSpoilerFalse = ({ id }: { id: string }) => {
  //現在表示されているレビュー
  ...
  useEffect(() => {
    subscribeSpoilerFalseReviews(id, setReviews, setLastVisible);
  }, [id]);
...
export default AnimeReviewSpoilerFalse;
